...
import { getProductById, updateProduct } from "@/utils/asyncStorageUtils";
...
export default function EditProductScreen() {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const result = await updateProduct(id as string, updatedProductData);
      ...
      >
        ...
        >
          ...
          <View style={styles.editModeIndicator}>
            <Text style={styles.editModeText}>Editing: {product.name}</Text>
          </View>
